          ...
          <c-box d="grid" gridTemplateColumns="1fr 1fr" gridGap="8">
            ...
            >
              <div class="PierSettingsOption" :class="{'selected': settings.listPageType === 'table'}">
                <img class="shadow-md rounded w-full object-cover object-left-top" src="./images/table.png" alt="">
              </div>
            ...
            >
              ...
              >
                <img class="shadow-md rounded-md w-full object-cover object-left-top" src="./images/card.png" alt="">
              </div>
